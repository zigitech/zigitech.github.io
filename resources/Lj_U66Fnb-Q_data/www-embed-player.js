...
b=qh("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Bf&&b.abort();
return yf(c)})}
...
function vn(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=$a(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
try{In("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Pn.push(Lg(function(){if(!(Qn||"google_ad_status"in window)){try{On("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Qn=!0;M("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&Xn.dispose();for(var a=0,b=Pn.length;a<b;a++)Og(Pn[a]);Pn.length=0;Nn("//static.doubleclick.net/instream/ad_status.js");Qn=!1;M("DCLKSTAT",0);qe(bp,ap);$o&&($o.removeEventListener("onVideoDataChange",cp),$o.destroy())});
