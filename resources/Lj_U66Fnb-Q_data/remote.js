(function(g){var window=this;'use strict';var WRa=function(a,b){return g.hc(a,b)},XRa=function(a,b){b=b instanceof g.qf?b:g.wf(b,/^data:image\//i.test(b));
...
g.bk(a.u,b,c)},YRa=function(a){if(a instanceof g.ho)return a;
...
return c}throw Error("Not implemented");},ZRa=function(a,b,c){if(g.Ka(a))try{g.Qb(a,b,c)}catch(d){if(d!==g.Xq)throw d;
}else{a=YRa(a);try{for(;;)b.call(c,a.qj(),void 0,a)}catch(d){if(d!==g.Xq)throw d;}}},$Ra=function(a,b){var c=[];
ZRa(b,function(d){try{var e=g.xr.prototype.u.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.wr(e)&&c.push(d)},a);
return c},aSa=function(a,b){$Ra(a,b).forEach(function(c){g.xr.prototype.remove.call(this,c)},a)},bSa=function(a){if(a.ma){if(a.ma.locationOverrideToken)return{locationOverrideToken:a.ma.locationOverrideToken};
if(null!=a.ma.latitudeE7&&null!=a.ma.longitudeE7)return{latitudeE7:a.ma.latitudeE7,longitudeE7:a.ma.longitudeE7}}return null},cSa=function(a,b){g.vb(a,b)||a.push(b)},Q6=function(a){var b=0,c;
for(c in a)b++;return b},dSa=function(a){try{return g.D.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},R6=function(a){if(g.D.JSON)try{return g.D.JSON.parse(a)}catch(b){}return dSa(a)},eSa=function(a,b,c,d){var e=new g.Oj(null,void 0);
...
a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",fSa(this,a.capabilities||""),gSa(this,a.experiments||""),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN",a=a.deviceInfo)&&(a=JSON.parse(a),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",
this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.clientName=a.clientName?a.clientName.toUpperCase():"UNKNOWN_INTERFACE",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN")},fSa=function(a,b){a.capabilities.clear();
g.Go(b.split(","),g.Oa(WRa,hSa)).forEach(function(c){a.capabilities.add(c)})},gSa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},U6=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},V6=function(a,b){return!!b&&(a.id==b||a.uuid==b)},iSa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},jSa=function(a){return new U6(a)},kSa=function(a){return Array.isArray(a)?g.pm(a,jSa):[]},W6=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},X6=function(a){return Array.isArray(a)?"["+g.pm(a,W6).join(",")+"]":"null"},Y6=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},lSa=function(a){return g.pm(a,function(b){return{key:b.id,
name:b.name}})},Z6=function(a,b){return g.sb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},$6=function(a,b){return g.sb(a,function(c){return V6(c,b)})},mSa=function(){var a=(0,g.Jz)();
a&&aSa(a,a.i.Lg(!0))},a7=function(){var a=g.Mz("yt-remote-connected-devices")||[];
g.Mb(a);return a},nSa=function(a){if(g.wb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.pm(a,function(d,e){return 0==e?d:d.substring(c.length)})},oSa=function(a){g.Lz("yt-remote-connected-devices",a,86400)},c7=function(){if(b7)return b7;
...
g.vb(a,b);g.Oz()&&g.Pb(a,b);a=nSa(a);if(g.wb(a))try{g.Pt("remote_sid")}catch(c){}else try{g.Nt("remote_sid",a.join(","),-1)}catch(c){}},pSa=function(){return g.Mz("yt-remote-session-browser-channel")},qSa=function(){return g.Mz("yt-remote-local-screens")||[]},rSa=function(){g.Lz("yt-remote-lounge-token-expiration",!0,86400)},sSa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.pm(qSa(),function(d){return d.loungeToken}),c=g.pm(a,function(d){return d.loungeToken});
g.qm(c,function(d){return!g.vb(b,d)})&&rSa();
g.Lz("yt-remote-local-screens",a,31536E3)},tSa=function(a,b){g.Lz("yt-remote-session-browser-channel",a);
g.Lz("yt-remote-session-screen-id",b);a=a7();b=c7();g.vb(a,b)||a.push(b);oSa(a);d7()},e7=function(a){a||(g.Nz("yt-remote-session-screen-id"),g.Nz("yt-remote-session-video-id"));
d7();a=a7();g.Ab(a,c7());oSa(a)},uSa=function(){if(!f7){var a=g.Hr();
a&&(f7=new g.rr(a))}},vSa=function(){uSa();
return f7?!!f7.get("yt-remote-use-staging-server"):!1},g7=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},wSa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},xSa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},h7=function(a){a.length?ySa(a.shift(),function(){h7(a)}):i7()},zSa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},ySa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.Wk(d,g.fr(a));(document.head||document.documentElement).appendChild(d)},ASa=function(){var a=g7(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},i7=function(){var a=xSa();
a&&a(!1,"No cast extension found")},j7=function(){if(BSa){var a=2,b=xSa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;ySa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",i7,c)}},CSa=function(){j7();
var a=ASa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");h7(a)},ESa=function(){j7();
var a=ASa();a.push.apply(a,g.v(DSa.map(zSa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");h7(a)},k7=function(a,b,c){g.I.call(this);
...
return g.D.setTimeout(function(){a()},b)},q7=function(a){p7.dispatchEvent(new FSa(p7,a))},FSa=function(a,b){g.ve.call(this,"statevent",a);
this.stat=b},r7=function(a,b,c,d){this.i=a;
this.B=b;this.S=c;this.K=d||1;this.u=45E3;this.C=new g.ck(this);this.J=new g.wh;this.J.setInterval(250)},HSa=function(a,b,c){a.nt=1;
a.Mm=O6(b.clone());a.lq=c;a.D=!0;GSa(a,null)},s7=function(a,b,c,d,e){a.nt=1;
a.Mm=O6(b.clone());a.lq=null;a.D=c;e&&(a.AN=!1);GSa(a,d)},GSa=function(a,b){a.Ps=Date.now();
t7(a);a.jo=a.Mm.clone();P6(a.jo,"t",a.K);a.mB=0;a.Mf=a.i.bD(a.i.bx()?b:null);0<a.bC&&(a.zA=new l7((0,g.F)(a.CO,a,a.Mf),a.bC));a.C.Qa(a.Mf,"readystatechange",a.hQ);b=a.No?g.pc(a.No):{};a.lq?(a.jB="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Mf.send(a.jo,a.jB,a.lq,b)):(a.jB="GET",a.AN&&!g.zg&&(b.Connection="close"),a.Mf.send(a.jo,a.jB,null,b));a.i.rj(1)},JSa=function(a,b){var c=a.mB,d=b.indexOf("\n",c);
if(-1==d)return u7;c=Number(b.substring(c,d));if(isNaN(c))return ISa;d+=1;if(d+c>b.length)return u7;b=b.substr(d,c);a.mB=d+c;return b},LSa=function(a,b){a.Ps=Date.now();
t7(a);var c=b?window.location.hostname:"";a.jo=a.Mm.clone();g.Wj(a.jo,"DOMAIN",c);g.Wj(a.jo,"t",a.K);try{a.Hj=new ActiveXObject("htmlfile")}catch(m){v7(a);a.Gm=7;q7(22);w7(a);return}var d="<html><body>";if(b){var e="";for(b=0;b<c.length;b++){var f=c.charAt(b);if("<"==f)f=e+"\\x3c";else if(">"==f)f=e+"\\x3e";else{if(f in x7)f=x7[f];else if(f in KSa)f=x7[f]=KSa[f];else{var h=f.charCodeAt(0);if(31<h&&127>h)var l=f;else{if(256>h){if(l="\\x",16>h||256<h)l+="0"}else l="\\u",4096>h&&(l+="0");l+=h.toString(16).toUpperCase()}f=
...
a.u;
MSa(a,a.u)},MSa=function(a,b){if(null!=a.Dt)throw Error("WatchDog timer not null");
...
g.se(a.zA);a.zA=null;a.J.stop();g.ek(a.C);if(a.Mf){var b=a.Mf;a.Mf=null;b.abort();b.dispose()}a.Hj&&(a.Hj=null)},z7=function(a,b){try{a.i.DM(a,b),a.i.rj(4)}catch(c){}},OSa=function(a,b,c,d,e){if(0==d)c(!1);
else{var f=e||0;d--;NSa(a,b,function(h){h?c(!0):g.D.setTimeout(function(){OSa(a,b,c,d,f)},f)})}},NSa=function(a,b,c){var d=new Image;
...
XRa(d,a)},A7=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},PSa=function(a){this.i=a;
this.u=new n7},QSa=function(a){var b=B7(a.i,a.Hu,"/mail/images/cleardot.gif");
O6(b);OSa(b.toString(),5E3,(0,g.F)(a.YQ,a),3,2E3);a.rj(1)},D7=function(a){var b=a.i.Y;
if(null!=b)q7(5),b?(q7(11),C7(a.i,a,!1)):(q7(12),C7(a.i,a,!0));else if(a.lh=new r7(a,void 0,void 0,void 0),a.lh.No=a.cC,b=a.i,b=B7(b,b.bx()?a.au:null,a.dC),q7(5),!g.Rc||g.Kc(10))P6(b,"TYPE","xmlhttp"),s7(a.lh,b,!1,a.au,!1);else{P6(b,"TYPE","html");var c=a.lh;a=!!a.au;c.nt=3;c.Mm=O6(b.clone());LSa(c,a)}},E7=function(a,b,c){this.i=1;
this.u=[];this.C=[];this.D=new n7;this.S=a||null;this.Y=null!=b?b:null;this.J=c||!1},RSa=function(a,b){this.i=a;
this.map=b;this.context=null},SSa=function(a,b,c,d){g.ve.call(this,"timingevent",a);
this.size=b;this.Sw=d},TSa=function(a){g.ve.call(this,"serverreachability",a)},WSa=function(a){USa(a);
if(3==a.i){var b=a.ew++,c=a.Hy.clone();g.Wj(c,"SID",a.B);g.Wj(c,"RID",b);g.Wj(c,"TYPE","terminate");F7(a,c);b=new r7(a,a.B,b,void 0);b.nt=2;b.Mm=O6(c.clone());XRa(new Image,b.Mm.toString());b.Ps=Date.now();t7(b)}VSa(a)},XSa=function(a){a.yR(1,0);
a.Hy=B7(a,null,a.eC);G7(a)},USa=function(a){a.Qm&&(a.Qm.abort(),a.Qm=null);
a.Ge&&(a.Ge.cancel(),a.Ge=null);a.yl&&(g.D.clearTimeout(a.yl),a.yl=null);H7(a);a.Vg&&(a.Vg.cancel(),a.Vg=null);a.cn&&(g.D.clearTimeout(a.cn),a.cn=null)},YSa=function(a,b){if(0==a.i)throw Error("Invalid operation: sending map when state is closed");
a.u.push(new RSa(a.dT++,b));2!=a.i&&3!=a.i||G7(a)},ZSa=function(a){var b=0;
a.Ge&&b++;a.Vg&&b++;return b},G7=function(a){a.Vg||a.cn||(a.cn=o7((0,g.F)(a.IM,a),0),a.Kr=0)},aTa=function(a,b){if(1==a.i){if(!b){a.ew=Math.floor(1E5*Math.random());
b=a.ew++;var c=new r7(a,"",b,void 0);c.No=a.Tj;var d=I7(a),e=a.Hy.clone();g.Wj(e,"RID",b);g.Wj(e,"CVER","1");F7(a,e);HSa(c,e,d);a.Vg=c;a.i=2}}else 3==a.i&&(b?$Sa(a,b):0==a.u.length||a.Vg||$Sa(a))},$Sa=function(a,b){if(b)if(6<a.hp){a.u=a.C.concat(a.u);
a.C.length=0;var c=a.ew-1;b=I7(a)}else c=b.S,b=b.lq;else c=a.ew++,b=I7(a);var d=a.Hy.clone();g.Wj(d,"SID",a.B);g.Wj(d,"RID",c);g.Wj(d,"AID",a.us);F7(a,d);c=new r7(a,a.B,c,a.Kr+1);c.No=a.Tj;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Vg=c;HSa(c,d,b)},F7=function(a,b){a.Nf&&(a=a.Nf.YJ())&&g.Xb(a,function(c,d){g.Wj(b,d,c)})},I7=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
...
return c.join("&")},bTa=function(a){a.Ge||a.yl||(a.K=1,a.yl=o7((0,g.F)(a.HM,a),0),a.rr=0)},J7=function(a){if(a.Ge||a.yl||3<=a.rr)return!1;
a.K++;a.yl=o7((0,g.F)(a.HM,a),cTa(a,a.rr));a.rr++;return!0},C7=function(a,b,c){a.hB=c;
a.Uj=b.bl;a.J||XSa(a)},H7=function(a){null!=a.qp&&(g.D.clearTimeout(a.qp),a.qp=null)},cTa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},K7=function(a,b){if(2==b||9==b){var c=null;
a.Nf&&(c=null);var d=(0,g.F)(a.kX,a);c||(c=new g.Oj("//www.google.com/images/cleardot.gif"),O6(c));NSa(c.toString(),1E4,d)}else q7(2);dTa(a,b)},dTa=function(a,b){a.i=0;
a.Nf&&a.Nf.mJ(b);VSa(a);USa(a)},VSa=function(a){a.i=0;
...
if(""!=d.i)b&&g.Qj(d,b+"."+d.i),g.Rj(d,d.B);else{var e=window.location;d=eSa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.fv&&g.Xb(a.fv,function(f,h){g.Wj(d,h,f)});
g.Wj(d,"VER",a.hp);F7(a,d);return d},eTa=function(){},fTa=function(){this.i=[];
this.u=[]},gTa=function(a,b){this.action=a;
...
e=void 0===e?!1:e;this.ya=a;this.J=b;this.B=new g.qr;this.u=new L7(this.OW,this);this.i=null;this.Z=!1;this.D=null;this.Y="";this.S=this.C=0;this.K=[];this.Aa=c;this.ma=d;this.Ea=e},hTa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.hB,sessionId:a.i.B,arrayId:a.i.us}},iTa=function(a,b){a.S=b||0;
a.u.stop();N7(a);a.i&&(3==a.i.getState()&&aTa(a.i),WSa(a.i));a.S=0},O7=function(a){return!!a.i&&3==a.i.getState()},N7=function(a){if(a.i){var b=a.ma(),c=a.i.Tj||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Oa(a.C,d,!0),onError:g.Oa(a.B,e),onTimeout:g.Oa(a.D,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.Ct(b,a)},mTa=function(){var a=jTa;
kTa();S7.push(a);lTa()},T7=function(a,b){kTa();
var c=nTa(a,String(b));g.wb(S7)?oTa(c):(lTa(),g.Qb(S7,function(d){d(c)}))},kTa=function(){S7||(S7=g.Ga("yt.mdx.remote.debug.handlers_")||[],g.Fa("yt.mdx.remote.debug.handlers_",S7,void 0))},oTa=function(a){var b=(U7+1)%50;
U7=b;V7[b]=a;W7||(W7=49==b)},lTa=function(){var a=S7;
if(V7[0]){var b=W7?U7:-1;do{b=(b+1)%50;var c=V7[b];g.Qb(a,function(d){d(c)})}while(b!=U7);
V7=Array(50);U7=-1;W7=!1}},nTa=function(a,b){var c=(Date.now()-pTa)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},X7=function(a){g.R.call(this);
this.J=a;this.screens=[]},qTa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.screens.push(b);return!0},rTa=function(a,b){var c=a.screens.length!=b.length;
a.screens=g.Go(a.screens,function(f){return!!Z6(b,f)});
for(var d=0,e=b.length;d<e;d++)c=qTa(a,b[d])||c;return c},sTa=function(a,b){var c=a.screens.length;
...
this.u=a;this.i=NaN;Z7(this);this.info("Initializing with "+X6(this.screens))},tTa=function(a){if(a.screens.length){var b=g.pm(a.screens,function(d){return d.id}),c=Q7(a.u,"/pairing/get_lounge_token_batch");
R7(a.u,c,{screen_ids:b.join(",")},(0,g.F)(a.UR,a),(0,g.F)(a.TR,a))}},Z7=function(a){if(g.zs("deprecate_pair_servlet_enabled"))return rTa(a,[]);
var b=kSa(qSa());b=g.Go(b,function(c){return!c.uuid});
return rTa(a,b)},a8=function(a,b){sSa(g.pm(a.screens,iSa));
b&&rSa()},c8=function(a,b){g.R.call(this);
...
else{c=g.fc(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(b8("Updated online screens: "+g.Yh(a.i)),a.i=b,a.ea("screenChange"));uTa(a)},f8=function(a){isNaN(a.B)||g.wt(a.B);
a.B=g.ut((0,g.F)(a.IF,a),0<a.C&&a.C<g.Pa()?2E4:1E4)},b8=function(a){T7("OnlineScreenService",a)},vTa=function(a){var b={};
g.Qb(a.J(),function(c){c.token?b[c.token]=c.id:this.le("Requesting availability of screen w/o lounge token.")});
return b},uTa=function(a){a=g.fc(g.Yb(a.i,function(b){return b}));
...
X7.call(this,"ScreenService");this.C=a;this.K=b;this.i=this.u=null;this.B=[];this.D={};wTa(this)},yTa=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.D[b]);var h=a.Fh(),l=c?$6(h,c):null;c&&(a.K||l)||(l=$6(h,b));if(l){l.uuid=b;var m=h8(a,l);d8(a.i,m,function(n){e(n?m:null)})}else c?xTa(a,c,(0,g.F)(function(n){var p=h8(this,new U6({name:d,
screenId:c,loungeToken:n,dialId:b||""}));d8(this.i,p,function(q){e(q?p:null)})},a),f):e(null)},zTa=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},ATa=function(a,b,c){d8(a.i,b,c)},xTa=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.Ct(Q7(a.C,"/pairing/get_lounge_token_batch"),e)},BTa=function(a){a.screens=a.u.Fh();
var b=a.D,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+X6(a.screens))},wTa=function(a){i8(a);
a.u=new $7(a.C);a.u.subscribe("screenChange",(0,g.F)(a.dS,a));BTa(a);a.K||(a.B=kSa(g.Mz("yt-remote-automatic-screen-cache")||[]));i8(a);a.info("Initializing automatic screens: "+X6(a.B));a.i=new c8(a.C,(0,g.F)(a.Fh,a,!0));a.i.subscribe("screenChange",(0,g.F)(function(){this.ea("onlineScreenChange")},a))},h8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=$6(a.B,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.B.push(b),a.K||CTa(a));i8(a);a.D[b.uuid]=b.id;g.Lz("yt-remote-device-id-map",a.D,31536E3);return b},CTa=function(a){a=g.Go(a.B,function(b){return"shortLived"!=b.idType});
g.Lz("yt-remote-automatic-screen-cache",g.pm(a,iSa))},i8=function(a){a.D=g.Mz("yt-remote-device-id-map")||{}},j8=function(a,b,c){g.R.call(this);
this.Ea=c;this.B=a;this.i=b;this.C=null},k8=function(a,b){a.C=b;
a.ea("sessionScreen",a.C)},DTa=function(a,b){a.C&&(a.C.token=b,h8(a.B,a.C));
a.ea("sessionScreen",a.C)},l8=function(a,b){T7(a.Ea,b)},m8=function(a,b,c){j8.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.u=null;this.ma=(0,g.F)(this.mQ,this);this.Aa=(0,g.F)(this.nW,this);this.Z=g.ut(function(){ETa(d,null)},12E4);
this.K=this.D=this.J=this.S=0;this.ya=!1;this.Y="unknown"},n8=function(a,b){g.wt(a.K);
a.K=0;0==b?FTa(a):a.K=g.ut(function(){FTa(a)},b)},FTa=function(a){GTa(a,"getLoungeToken");
g.wt(a.D);a.D=g.ut(function(){HTa(a,null)},3E4)},GTa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.Yh(void 0));
var c={};c.type=b;a.u?a.u.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ha,(0,g.F)(function(){l8(this,"Failed to send message: "+b+".")},a)):l8(a,"Sending yt message without session: "+g.Yh(c))},o8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.mK(b,function(c){k8(a,c)},function(){return a.zg()},5)):a.zg(Error("Waiting for session status timed out."))},JTa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new U6(b);ITa(a,d,function(e){e?(a.ya=!0,h8(a.B,d),k8(a,d),a.Y="unknown",n8(a,c)):(g.Ds(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.zg())},5)},ETa=function(a,b){g.wt(a.Z);
a.Z=0;b?a.config_.enableCastLoungeToken&&b.loungeToken?b.deviceId?a.getScreen()&&a.getScreen().uuid==b.deviceId||(b.loungeTokenRefreshIntervalMs?JTa(a,{name:a.i.friendlyName,screenId:b.screenId,loungeToken:b.loungeToken,dialId:b.deviceId,screenIdType:"shortLived"},b.loungeTokenRefreshIntervalMs):(g.Ds(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: "+JSON.stringify(b)+".")),o8(a,b.screenId))):(g.Ds(Error("No device id presents in mdxSessionStatusData: "+JSON.stringify(b)+
".")),o8(a,b.screenId)):o8(a,b.screenId):a.zg(Error("Waiting for session status timed out."))},HTa=function(a,b){g.wt(a.D);
a.D=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.Y=c,n8(a,3E4)):(DTa(a,b.loungeToken),a.ya=!1,a.Y="unknown",n8(a,b.loungeTokenRefreshIntervalMs))},ITa=function(a,b,c,d){g.wt(a.J);
a.J=0;ATa(a.B,b,function(e){e||0>d?c(e):a.J=g.ut(function(){ITa(a,b,c,d-1)},300)})},KTa=function(a){g.wt(a.S);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.u)?0:b.getDialAppInfo))},LTa=function(a){a.D=a.B.SH(a.Aa,a.i.label,a.i.friendlyName,q8(a),function(b,c){a.D=g.Ha;
a.ma=!0;k8(a,b);"shortLived"==b.idType&&0<c&&r8(a,c)},function(b){a.D=g.Ha;
a.zg(b)})},MTa=function(a){var b={};
b.pairingCode=a.Aa;b.theme=a.La;vSa()&&(b.env_useStageMdx=1);return g.qi(b)},s8=function(a){return new Promise(function(b){a.Aa=Y6();
if(a.Ja){var c=new chrome.cast.DialLaunchResponse(!0,MTa(a));b(c);LTa(a)}else a.Z=function(){g.wt(a.Y);a.Z=function(){};
a.Y=NaN;var d=new chrome.cast.DialLaunchResponse(!0,MTa(a));b(d);LTa(a)},a.Y=g.ut(function(){a.Z()},100)})},OTa=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new U6(b);return(new Promise(function(e){NTa(a,d,function(f){f?(a.ma=!0,h8(a.B,d),k8(a,d),r8(a,c)):g.Ds(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):s8(a)})},PTa=function(a,b){var c=a.S.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){yTa(a.B,c,b,d,function(f){f&&f.token&&k8(a,f);e(f)},function(f){l8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):s8(a)})},NTa=function(a,b,c,d){g.wt(a.J);
a.J=0;ATa(a.B,b,function(e){e||0>d?c(e):a.J=g.ut(function(){NTa(a,b,c,d-1)},300)})},r8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
q8(a)&&(g.wt(a.K),a.K=0,0==b?QTa(a):a.K=g.ut(function(){QTa(a)},b))},QTa=function(a){q8(a)&&a.u.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.ya=c,r8(a,3E4)):(a.ma=!1,a.ya="unknown",DTa(a,b.loungeToken),r8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.ya="noLoungeTokenResponse";r8(a,3E4)})},RTa=function(a){g.wt(a.J);
...
this.config_=b;this.u=a;this.S=b.appId||"233637DE";this.C=b.theme||"cl";this.Y=b.disableCastApi||!1;this.J=b.forceMirroring||!1;this.i=null;this.K=!1;this.B=[];this.D=(0,g.F)(this.fV,this)},STa=function(a,b){return b?g.sb(a.B,function(c){return V6(b,c.label)},a):null},v8=function(a){T7("Controller",a)},jTa=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},w8=function(a){return a.K||!!a.B.length||!!a.i},x8=function(a,b,c){b!=a.i&&(g.se(a.i),(a.i=b)?(c?a.ea("yt-remote-cast2-receiver-resumed",
b.i):a.ea("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.F)(a.GM,a,b)),b.subscribe("sessionFailed",function(){return TTa(a,b)}),b.getScreen()?a.ea("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.ws(null)):a.ea("yt-remote-cast2-session-change",null))},TTa=function(a,b){a.i==b&&a.ea("yt-remote-cast2-session-failed")},UTa=function(a){var b=a.u.RH(),c=a.i&&a.i.i;
a=g.pm(b,function(d){c&&V6(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=STa(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},ZTa=function(a,b,c,d){d.disableCastApi?y8("Cannot initialize because disabled by Mdx config."):VTa()?WTa(b,d)&&(z8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?XTa(a,c):(window.__onGCastApiAvailable=function(e,f){e?XTa(a,c):(A8("Failed to load cast API: "+f),B8(!1),z8(!1),g.Nz("yt-remote-cast-available"),g.Nz("yt-remote-cast-receiver"),
YTa(),c(!1))},d.loadCastApiSetupScript?g.Pz("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=g7()&&CSa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?i7():89<=g7()?ESa():(j7(),h7(DSa.map(zSa))))):y8("Cannot initialize because not running Chrome")},YTa=function(){y8("dispose");
var a=C8();a&&a.dispose();g.Fa("yt.mdx.remote.cloudview.instance_",null,void 0);$Ta(!1);g.iv(D8);D8.length=0},E8=function(){return!!g.Mz("yt-remote-cast-installed")},aUa=function(){var a=g.Mz("yt-remote-cast-receiver");
return a?a.friendlyName:null},bUa=function(){y8("clearCurrentReceiver");
g.Nz("yt-remote-cast-receiver")},cUa=function(){return E8()?C8()?C8().getCastSession():(A8("getCastSelector: Cast is not initialized."),null):(A8("getCastSelector: Cast API is not installed!"),null)},G8=function(){E8()?C8()?F8()?(y8("Requesting cast selector."),C8().requestSession()):(y8("Wait for cast API to be ready to request the session."),D8.push(g.hv("yt-remote-cast2-api-ready",G8))):A8("requestCastSelector: Cast is not initialized."):A8("requestCastSelector: Cast API is not installed!")},H8=
function(a,b){F8()?C8().setConnectedScreenStatus(a,b):A8("setConnectedScreenStatus called before ready.")},VTa=function(){var a=0<=g.Vb.search(/ (CrMo|Chrome|CriOS)\//);
return g.Vi||a},dUa=function(a,b){C8().init(a,b)},WTa=function(a,b){var c=!1;
...
y8("cloudview.createSingleton_: "+c);return c},C8=function(){return g.Ga("yt.mdx.remote.cloudview.instance_")},XTa=function(a,b){B8(!0);
z8(!1);dUa(a,function(c){c?($Ta(!0),g.jv("yt-remote-cast2-api-ready")):(A8("Failed to initialize cast API."),B8(!1),g.Nz("yt-remote-cast-available"),g.Nz("yt-remote-cast-receiver"),YTa());b(c)})},y8=function(a){T7("cloudview",a)},A8=function(a){T7("cloudview",a)},B8=function(a){y8("setCastInstalled_ "+a);
g.Lz("yt-remote-cast-installed",a)},F8=function(){return!!g.Ga("yt.mdx.remote.cloudview.apiReady_")},$Ta=function(a){y8("setApiReady_ "+a);
...
this.B=0;this.C=a;this.J=[];this.D=new fTa;this.u=this.i=null;this.Y=(0,g.F)(this.LT,this);this.K=(0,g.F)(this.ow,this);this.S=(0,g.F)(this.KT,this);this.Z=(0,g.F)(this.TT,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.YF,this),eUa(this))):c=3;0!=c&&(b?this.YF(c):g.ut((0,g.F)(function(){this.YF(c)},this),0));
(a=cUa())&&P8(this,a);this.subscribe("yt-remote-cast2-session-change",this.Z)},R8=function(a){return new I8(a.C.getPlayerContextData())},eUa=function(a){g.Qb("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "),function(b){this.J.push(this.C.subscribe(b,g.Oa(this.dV,b),this))},a)},fUa=function(a){g.Qb(a.J,function(b){this.C.unsubscribeByKey(b)},a);
...
L8(d,c);-1E3!=d.playerState&&(d.playerState=b);U8(a,d)},W8=function(a,b,c){a.C.sendMessage(b,c)},U8=function(a,b){fUa(a);
a.C.setPlayerContextData(O8(b));eUa(a)},P8=function(a,b){a.u&&(a.u.removeUpdateListener(a.Y),a.u.removeMediaListener(a.K),a.ow(null));
a.u=b;a.u&&(T7("CP","Setting cast session: "+a.u.sessionId),a.u.addUpdateListener(a.Y),a.u.addMediaListener(a.K),a.u.media.length&&a.ow(a.u.media[0]))},gUa=function(a){var b=a.i.media,c=a.i.customData;
...
g.R.call(this);this.D=NaN;this.ya=!1;this.S=this.K=this.Z=this.ma=NaN;this.Y=[];this.C=this.J=this.B=this.hc=this.i=null;this.Ka=a;this.Ea=d;this.Y.push(g.Au(window,"beforeunload",(0,g.F)(this.PR,this)));this.u=[];this.hc=new I8;this.Ja=b.id;this.Aa=b.idType;this.i=hUa(this,c);this.i.subscribe("handlerOpened",this.QT,this);this.i.subscribe("handlerClosed",this.NT,this);this.i.subscribe("handlerError",this.OT,this);this.i.subscribe("handlerMessage",this.PT,this);this.i.LA(b.token);this.subscribe("remoteQueueChange",
function(){var e=this.hc.videoId;g.Oz()&&g.Lz("yt-remote-session-video-id",e)},this)},iUa=function(a){return g.sb(a.u,function(b){return"LOUNGE_SCREEN"==b.type})},Z8=function(a){T7("conn",a)},hUa=function(a,b){return new M7(Q7(a.Ka,"/bc"),b,!1,function(){return a.WH()},"shortLived"==a.Aa)},$8=function(a,b){a.ea("proxyStateChange",b)},jUa=function(a){a.D=g.ut((0,g.F)(function(){Z8("Connecting timeout");
this.Gr(1)},a),2E4)},a9=function(a){g.wt(a.D);
a.D=NaN},b9=function(a){g.wt(a.ma);
a.ma=NaN},kUa=function(a){c9(a);
a.Z=g.ut((0,g.F)(function(){d9(this,"getNowPlaying")},a),2E4)},c9=function(a){g.wt(a.Z);
a.Z=NaN},mUa=function(a,b){var c=null;
if(b){var d=iUa(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Fa("yt.mdx.remote.remoteClient_",c,void 0);b&&(a9(a),b9(a));c=O7(a.i)&&isNaN(a.D);b==c?b&&($8(a,1),d9(a,"getSubtitlesTrack")):b?(a.lK()&&a.hc.reset(),$8(a,1),d9(a,"getNowPlaying"),lUa(a)):a.Gr(1)},nUa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.hc.videoId&&(g.lc(b.params)?a.hc.trackData=null:a.hc.trackData=b.params,a.ea("remotePlayerChange"))},oUa=function(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);
a.hc.listId=b.params.listId||a.hc.listId;N8(a.hc,c,d);a.ea("remoteQueueChange")},qUa=function(a,b){b.params=b.params||{};
oUa(a,b);pUa(a,b);a.ea("autoplayDismissed")},pUa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
L8(a.hc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.hc.playerState&&(c=-1E3);a.hc.playerState=c;c=Number(b.params.loadedTime);a.hc.S=isNaN(c)?0:c;a.hc.Cj(Number(b.params.duration));c=a.hc;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.hc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.hc.playerState?kUa(a):c9(a);a.ea("remotePlayerChange")},rUa=function(a,b){if(-1E3!=a.hc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.hc.playerState=c;b=parseInt(b.params.currentTime,10);L8(a.hc,isNaN(b)?0:b);a.ea("remotePlayerChange")}},sUa=function(a,b){var c="true"==b.params.muted;
a.hc.volume=parseInt(b.params.volume,10);a.hc.muted=c;a.ea("remotePlayerChange")},tUa=function(a,b){a.J=b.params.videoId;
a.ea("nowAutoplaying",parseInt(b.params.timeout,10))},uUa=function(a,b){var c="true"==b.params.hasNext;
a.hc.yk="true"==b.params.hasPrevious;a.hc.hasNext=c;a.ea("previousNextChange")},lUa=function(a){g.wt(a.S);
...
this.Pe=a;this.i=[];this.i.push(this.Pe.$_s("screenChange",(0,g.F)(this.rQ,this)));this.i.push(this.Pe.$_s("onlineScreenChange",(0,g.F)(this.KU,this)))},yUa=function(a,b){uSa();
if(!f7||!f7.get("yt-remote-disable-remote-module-for-dev")){b=g.P("MDX_CONFIG")||b;mSa();d7();f9||(f9=new P7(b?b.loungeApiHost:void 0),vSa()&&(f9.i="/api/loungedev"));g9||(g9=g.Ga("yt.mdx.remote.deferredProxies_")||[],g.Fa("yt.mdx.remote.deferredProxies_",g9,void 0));vUa();var c=h9();if(!c){var d=new g8(f9,b?b.disableAutomaticScreenCache||!1:!1);g.Fa("yt.mdx.remote.screenService_",d,void 0);c=h9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Fa("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);ZTa(a,d,function(f){f?i9()&&H8(i9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){S6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ga("yt.mdx.remote.initialized_")&&(g.Fa("yt.mdx.remote.initialized_",!0,void 0),j9("Initializing: "+
...
S6("yt-remote-auto-connect","cast-selector-receiver")})),k9.push(g.hv("yt-remote-cast2-receiver-resumed",function(){S6("yt-remote-receiver-resumed","cast-selector-receiver")})),k9.push(g.hv("yt-remote-cast2-session-change",wUa)),k9.push(g.hv("yt-remote-connection-change",function(f){f?H8(i9(),"YouTube TV"):m9()||(H8(null,null),bUa())})),k9.push(g.hv("yt-remote-cast2-session-failed",function(){S6("yt-remote-connection-failed")})),a=n9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.zs("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),j9(" -- with channel params: "+g.Yh(a)),a?(g.Lz("yt-remote-session-app",a.app),g.Lz("yt-remote-session-name",a.name)):(g.Nz("yt-remote-session-app"),g.Nz("yt-remote-session-name")),g.Fa("yt.mdx.remote.channelParams_",a,void 0),c.start(),i9()||xUa())}},zUa=function(){var a=h9().Pe.$_gos();
var b=o9();b&&p9()&&(Z6(a,b)||a.push(b));return lSa(a)},q9=function(){var a=AUa();
!a&&E8()&&aUa()&&(a={key:"cast-selector-receiver",name:aUa()});return a},AUa=function(){var a=zUa(),b=o9();
b||(b=m9());return g.sb(a,function(c){return b&&V6(b,c.key)?!0:!1})},o9=function(){var a=i9();
if(!a)return null;var b=h9().Fh();return $6(b,a)},wUa=function(a){j9("remote.onCastSessionChange_: "+W6(a));
...
w9=a?new e9(a):null}return w9},i9=function(){return g.Ga("yt.mdx.remote.currentScreenId_")},BUa=function(a){g.Fa("yt.mdx.remote.currentScreenId_",a,void 0)},CUa=function(){return g.Ga("yt.mdx.remote.connectData_")},l9=function(a){g.Fa("yt.mdx.remote.connectData_",a,void 0)},p9=function(){return g.Ga("yt.mdx.remote.connection_")},u9=function(a){var b=p9();
l9(null);a||BUa("");g.Fa("yt.mdx.remote.connection_",a,void 0);g9&&(g.Qb(g9,function(c){c(a)}),g9.length=0);
...
o9()&&o9();if(x9)r9=a;else{BUa(a.id);var c=g.Ga("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new Y8(f9,a,n9(),c);a.connect(b,CUa());a.subscribe("beforeDisconnect",function(d){S6("yt-remote-before-disconnect",d)});
...
u9(a)}},xUa=function(){var a=m9();
a?(j9("Resume connection to: "+W6(a)),t9(a,0)):(e7(),bUa(),j9("Skipping connecting because no session screen found."))},vUa=function(){var a=n9();
...
var d=this;this.u=a;this.I=b;this.Tb=c;this.events=new g.rD(this);this.Z=this.events.T(this.I,"onVolumeChange",function(e){DUa(d,e)});
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.I.getVideoData(1);a.Tb.playVideo(c.videoId,b,d,e,c.playerParams,c.Ya,bSa(c));a.Ub(new g.QJ(1))},FUa=function(a,b){if(b){var c=a.I.getOption("captions","tracklist",{KK:1});
...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",va:"\u60a8\u5df2\u9000\u51fa\u5e10\u53f7"},{G:"div",L:"ytp-mdx-popup-description",va:"\u60a8\u89c2\u770b\u7684\u89c6\u9891\u53ef\u80fd\u4f1a\u6dfb\u52a0\u5230\u7535\u89c6\u7684\u89c2\u770b\u8bb0\u5f55\u4e2d\uff0c\u5e76\u5f71\u54cd\u7535\u89c6\u4e0a\u7684\u63a8\u8350\u5185\u5bb9\u3002\u4e3a\u907f\u514d\u53d1\u751f\u8fd9\u79cd\u60c5\u51b5\uff0c\u8bf7\u53d6\u6d88\u5e76\u5728\u8ba1\u7b97\u673a\u4e0a\u767b\u5f55 YouTube\u3002"},
{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-cancel"],va:"\u53d6\u6d88"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"\u786e\u8ba4"}]}]}]});this.i=new g.vL(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},D9=function(a){g.V.call(this,{G:"div",
L:"ytp-remote",U:[{G:"div",L:"ytp-remote-display-status",U:[{G:"div",L:"ytp-remote-display-status-icon",U:[g.Rsa()]},{G:"div",L:"ytp-remote-display-status-text",va:"{{statustext}}"}]}]});this.api=a;this.i=new g.vL(this,250);g.J(this,this.i);this.T(a,"presentingplayerstatechange",this.onStateChange);GUa(this,a.yb())},GUa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.T(b,128)?g.mI("\u5728$RECEIVER_NAME\u4e0a\u51fa\u73b0\u9519\u8bef",c):b.Ec()||g.T(b,4)?g.mI("\u6b63\u5728$RECEIVER_NAME\u4e0a\u64ad\u653e",c):g.mI("\u5df2\u8fde\u63a5\u5230$RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},E9=function(a,b){g.JP.call(this,"\u64ad\u653e\u8bbe\u5907",0,a,b);
...
n7.prototype.parse=function(a){return g.D.JSON.parse(a,void 0)};var p7=new g.Se;g.w(FSa,g.ve);g.k=r7.prototype;g.k.No=null;g.k.ym=!1;g.k.Dt=null;g.k.QG=null;g.k.Ps=null;g.k.nt=null;g.k.Mm=null;g.k.jo=null;g.k.lq=null;g.k.Mf=null;g.k.mB=0;g.k.Hj=null;g.k.jB=null;g.k.Gm=null;g.k.Zt=-1;g.k.AN=!0;g.k.gp=!1;g.k.bC=0;g.k.zA=null;var ISa={},u7={};g.k=r7.prototype;g.k.setTimeout=function(a){this.u=a};
g.k.hQ=function(a){a=a.target;var b=this.zA;b&&3==g.Fi(a)?b.QH():this.CO(a)};
g.k.CO=function(a){try{if(a==this.Mf)a:{var b=g.Fi(this.Mf),c=this.Mf.u,d=this.Mf.getStatus();if(g.Rc&&!g.Kc(10)||g.zg&&!g.Jc("420+")){if(4>b)break a}else if(3>b||3==b&&!g.Ki(this.Mf))break a;this.gp||4!=b||7==c||(8==c||0>=d?this.i.rj(3):this.i.rj(2));y7(this);var e=this.Mf.getStatus();this.Zt=e;var f=g.Ki(this.Mf);if(this.ym=200==e){4==b&&v7(this);if(this.D){for(a=!0;!this.gp&&this.mB<f.length;){var h=JSa(this,f);if(h==u7){4==b&&(this.Gm=4,q7(15),a=!1);break}else if(h==ISa){this.Gm=4;q7(16);a=!1;
...
a&&H7(this),!g.$a(b))for(a=this.D.parse(b),b=0;b<a.length;b++)c=a[b],this.us=c[0],c=c[1],2==this.i?"c"==c[0]?(this.B=c[1],this.Ox=c[2],c=c[3],null!=c?this.hp=c:this.hp=6,this.i=3,this.Nf&&this.Nf.oJ(),this.WI=B7(this,this.bx()?this.Ox:null,this.eC),bTa(this)):"stop"==c[0]&&K7(this,7):3==this.i&&("stop"==c[0]?K7(this,7):"noop"!=c[0]&&this.Nf&&this.Nf.nJ(c),this.rr=0)};
g.k.FT=function(){null!=this.qp&&(this.qp=null,this.Ge.cancel(),this.Ge=null,J7(this),q7(20))};
g.k.Nx=function(a){if(this.Ge==a){H7(this);this.Ge=null;var b=2}else if(this.Vg==a)this.Vg=null,b=1;else return;this.Uj=a.Zt;if(0!=this.i)if(a.ym)if(1==b){b=Date.now()-a.Ps;var c=p7;c.dispatchEvent(new SSa(c,a.lq?a.lq.length:0,b,this.Kr));G7(this);this.C.length=0}else bTa(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.Uj)){if(d=1==b)this.Vg||this.cn||1==this.i||2<=this.Kr?d=!1:(this.cn=o7((0,g.F)(this.IM,this,a),cTa(this,this.Kr)),this.Kr++,d=!0);d=!(d||2==b&&J7(this))}if(d)switch(c){case 1:K7(this,
...
g.k.kX=function(a){a?q7(2):(q7(1),dTa(this,8))};
...
g.k.rj=function(a){var b=p7;b.dispatchEvent(new TSa(b,a))};
g.k.bx=function(){return!(!g.Rc||g.Kc(10))};
g.k=eTa.prototype;g.k.oJ=function(){};
g.k.nJ=function(){};
g.k.mJ=function(){};
g.k.OC=function(){};
g.k.YJ=function(){return{}};
g.k.isActive=function(){return!0};g.k=fTa.prototype;g.k.isEmpty=function(){return 0===this.i.length&&0===this.u.length};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Uf=5E3};g.Qa(M7,eTa);g.k=M7.prototype;g.k.subscribe=function(a,b,c){return this.B.subscribe(a,b,c)};
...
g.k.dispose=function(){this.Z||(this.Z=!0,g.se(this.B),iTa(this),g.se(this.u),this.u=null,this.ma=function(){return""})};
g.k.isDisposed=function(){return this.Z};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.Y="";this.u.stop();this.D=a||null;this.C=b||0;a=this.ya+"/test";b=this.ya+"/bind";var d=new E7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.Aa),e=this.i;e&&(e.Nf=null);d.Nf=this;this.i=d;N7(this);if(this.i){d=g.P("ID_TOKEN");var f=this.i.Tj||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.Tj=f}e?(3!=e.getState()&&0==ZSa(e)||e.getState(),this.i.connect(a,b,this.J,e.B,e.us)):c?this.i.connect(a,
b,this.J,c.sessionId,c.arrayId):this.i.connect(a,b,this.J)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.tc(a,b);this.u.isActive()||2==(this.i?this.i.getState():0)?this.K.push(a):O7(this)&&(N7(this),YSa(this.i,a))};
g.k.oJ=function(){this.u.reset();this.D=null;this.C=0;if(this.K.length){var a=this.K;this.K=[];for(var b=0,c=a.length;b<c;++b)YSa(this.i,a[b])}this.ea("handlerOpened")};
...
g.k.nJ=function(a){"S"==a[0]?this.Y=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),WSa(this.i)):this.ea("handlerMessage",new gTa(a[0],a[1]))};
...
g.k.OW=function(){this.u.isActive();0==ZSa(this.i)&&this.connect(this.D,this.C)};P7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
P7.prototype.B=function(a,b){a(Error("Request error: "+b.status))};
P7.prototype.D=function(a){a(Error("request timed out"))};var pTa=Date.now(),S7=null,V7=Array(50),U7=-1,W7=!1;g.Qa(X7,g.R);X7.prototype.Fh=function(){return this.screens};
...
g.k.iQ=function(a){this.i=null;a.status&&404==a.status?this.u>=JUa.length?this.ea("pairingFailed",Error("DIAL polling timed out")):(a=JUa[this.u],this.Lb=g.ut((0,g.F)(this.VM,this),a),this.u++):this.ea("pairingFailed",Error("Server error "+a.status))};
g.k.kQ=function(){this.i=null;this.ea("pairingFailed",Error("Server not responding"))};
var JUa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Qa($7,X7);g.k=$7.prototype;g.k.start=function(){Z7(this)&&this.ea("screenChange");!g.Mz("yt-remote-lounge-token-expiration")&&tTa(this);g.wt(this.i);this.i=g.ut((0,g.F)(this.start,this),1E4)};
g.k.add=function(a,b){Z7(this);qTa(this,a);a8(this,!1);this.ea("screenChange");b(a);a.token||tTa(this)};
g.k.remove=function(a,b){var c=Z7(this);sTa(this,a)&&(a8(this,!1),c=!0);b(a);c&&this.ea("screenChange")};
...
g.k.IF=function(){g.wt(this.B);this.B=NaN;this.u&&this.u.abort();var a=vTa(this);if(Q6(a)){var b=Q7(this.D,"/pairing/get_screen_availability");this.u=R7(this.D,b,{lounge_token:g.fc(a).join(",")},(0,g.F)(this.zV,this,a),(0,g.F)(this.xV,this))}else e8(this,{}),f8(this)};
g.k.zV=function(a,b){this.u=null;var c=g.fc(vTa(this));if(g.Ob(c,g.fc(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;e8(this,c);f8(this)}else this.le("Changing Screen set during request."),this.IF()};
...
g.k.lQ=function(a,b,c,d){g.Ct(Q7(this.C,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.F)(function(e,f){e=new U6(f.screen||{});if(!e.name||zTa(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);zTa(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(h8(this,e))},this),
...
g.k.dS=function(){BTa(this);this.ea("screenChange");this.i.update()};
...
g.k.xa=function(){this.XF("");j8.ke.xa.call(this)};g.w(m8,j8);g.k=m8.prototype;g.k.WF=function(a){if(this.u){if(this.u==a)return;l8(this,"Overriding cast session with new session object");KTa(this);this.ya=!1;this.Y="unknown";this.u.removeUpdateListener(this.ma);this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa)}this.u=a;this.u.addUpdateListener(this.ma);this.u.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa);GTa(this,"getMdxSessionStatus")};
...
g.k.XF=function(){};
g.k.xa=function(){this.info("disposeInternal");KTa(this);this.u&&(this.u.removeUpdateListener(this.ma),this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa));this.u=null;j8.prototype.xa.call(this)};
g.k.nW=function(a,b){if(!this.isDisposed())if(b)if(b=R6(b),g.La(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.Yh(b)),a){case "mdxSessionStatus":ETa(this,b);break;case "loungeToken":HTa(this,b);break;default:l8(this,"Unknown youtube message: "+a)}else l8(this,"Unable to parse message.");else l8(this,"No data in message.")};
g.k.mK=function(a,b,c,d){g.wt(this.S);this.S=0;yTa(this.B,this.i.label,a,this.i.friendlyName,(0,g.F)(function(e){e?b(e):0<=d?(l8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.S=g.ut((0,g.F)(this.mK,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){RTa(this);this.u?this.u.stop((0,g.F)(this.zg,this,null),(0,g.F)(this.zg,this,"Failed to stop DIAL device.")):this.zg()};
g.k.xa=function(){RTa(this);this.u&&this.u.removeUpdateListener(this.Ka);this.u=null;j8.prototype.xa.call(this)};
...
chrome.cast.initialize(c,(0,g.F)(function(){this.isDisposed()||(chrome.cast.addReceiverActionListener(this.D),mTa(),this.u.subscribe("onlineScreenChange",(0,g.F)(this.UH,this)),this.B=UTa(this),chrome.cast.setCustomReceivers(this.B,g.Ha,(0,g.F)(function(f){this.le("Failed to set initial custom receivers: "+g.Yh(f))},this)),this.ea("yt-remote-cast2-availability-change",w8(this)),b(!0))},this),(0,g.F)(function(f){this.le("Failed to initialize API: "+g.Yh(f));
b(!1)},this))};
g.k.TW=function(a,b){v8("Setting connected screen ID: "+a+" -> "+b);if(this.i){var c=this.i.getScreen();if(!a||c&&c.id!=a)v8("Unsetting old screen status: "+this.i.i.friendlyName),x8(this,null)}if(a&&b){if(!this.i){c=$6(this.u.Fh(),a);if(!c){v8("setConnectedScreenStatus: Unknown screen.");return}if("shortLived"==c.idType){v8("setConnectedScreenStatus: Screen with id type to be short lived.");return}a=STa(this,c);a||(v8("setConnectedScreenStatus: Connected receiver not custom..."),a=new chrome.cast.Receiver(c.uuid?
...
g.k.xa=function(){this.u.unsubscribe("onlineScreenChange",(0,g.F)(this.UH,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.D);var a=jTa,b=g.Ga("yt.mdx.remote.debug.handlers_");g.Ab(b||[],a);g.se(this.i);g.R.prototype.xa.call(this)};
...
this.ea("yt-remote-cast2-session-change",this.i.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.le('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);x8(this,new p8(this.u,b,this.C,this.config_))}b=this.i;b.S=a;b.S.appState==chrome.cast.DialAppState.RUNNING?(a=b.S.extraData||{},c=a.screenId||null,q8(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=OTa(b,{name:b.i.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.S.receiver.label,
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.Ds(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=PTa(b,c)):a=PTa(b,c)):a=s8(b);return a};
...
g.k.UH=function(){this.isDisposed()||(this.B=UTa(this),v8("Updating custom receivers: "+g.Yh(this.B)),chrome.cast.setCustomReceivers(this.B,g.Ha,(0,g.F)(function(){this.le("Failed to set custom receivers.")},this)),this.ea("yt-remote-cast2-availability-change",w8(this)))};
...
g.k.xa=function(){fUa(this);this.C=null;this.D.clear();P8(this,null);g.R.prototype.xa.call(this)};
...
g.k.ow=function(a){T7("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.S);if(this.i=a)this.i.addUpdateListener(this.S),gUa(this),this.ea("remotePlayerChange")};
g.k.KT=function(a){a?(gUa(this),this.ea("remotePlayerChange")):this.ow(null)};
g.k.tG=function(){W8(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.TT=function(){var a=cUa();a&&P8(this,a)};
...
n);this.C="UNSUPPORTED";c=this.Ea?"setInitialState":"setPlaylist";Z8("Connecting with "+c+" and params: "+g.Yh(m));this.i.connect({method:c,params:g.Yh(m)},a,pSa())}else Z8("Connecting without params"),this.i.connect({},a,pSa());jUa(this)};
...
mUa(this,a);a=this.XK("mlm");this.ea("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.Bb(this.u,function(c){return"LOUNGE_SCREEN"==c.type});
mUa(this,!1);break;case "remoteConnected":var b=new T6(R6(a.params.device));g.sb(this.u,function(c){return b?c.id==b.id:!1})||cSa(this.u,b);
break;case "remoteDisconnected":b=new T6(R6(a.params.device));g.Bb(this.u,function(c){return b?c.id==b.id:!1});
break;case "gracefulDisconnect":break;case "playlistModified":oUa(this,a);break;case "nowPlaying":qUa(this,a);break;case "onStateChange":pUa(this,a);break;case "onAdStateChange":rUa(this,a);break;case "onVolumeChanged":sUa(this,a);break;case "onSubtitlesTrackChanged":nUa(this,a);break;case "nowAutoplaying":tUa(this,a);break;case "autoplayDismissed":this.ea("autoplayDismissed");break;case "autoplayUpNext":this.J=a.params.videoId||null;this.ea("autoplayUpNext",this.J);break;case "onAutoplayModeChanged":this.C=
a.params.autoplayMode;this.ea("autoplayModeChange",this.C);"DISABLED"==this.C&&this.ea("autoplayDismissed");break;case "onHasPreviousNextChanged":uUa(this,a);break;case "requestAssistedSignIn":this.ea("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.ea("loopModeChange",a.params.loopMode);break;default:Z8("Unrecognized action: "+a.action)}};
...
g.k.Gr=function(a){Z8("Disconnecting with "+a);g.Fa("yt.mdx.remote.remoteClient_",null,void 0);a9(this);this.ea("beforeDisconnect",a);1==a&&e7();iTa(this.i,a);this.dispose()};
...
g.k.SW=function(a,b){d9(this,a,b);lUa(this)};
...
g.k.vU=function(){g.lc(this.C)||FUa(this,this.C);this.D=!1};
...
break;case -1:this.Ub(new g.QJ(64));break;case -1E3:this.Ub(new g.QJ(128,{errorCode:"mdx.remoteerror",errorMessage:"\u6b64\u89c6\u9891\u65e0\u6cd5\u8fdc\u7a0b\u64ad\u653e\u3002"}))}a=R8(this.Tb).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,FUa(this,a));a=R8(this.Tb);-1===a.volume||Math.round(this.I.getVolume())===a.volume&&this.I.isMuted()===a.muted||this.Y.isActive()||this.uO()}else EUa(this)};
g.k.zM=function(){this.I.ea("mdxpreviousnextchange")};
g.k.eA=function(){z9(this)||EUa(this)};
...
g.k.uO=function(){var a=this;if(z9(this)){var b=R8(this.Tb);this.events.jc(this.Z);b.muted?this.I.mute():this.I.unMute();this.I.setVolume(b.volume);this.Z=this.events.T(this.I,"onVolumeChange",function(c){DUa(a,c)})}};
...
g.k.Ub=function(a){this.B.stop();var b=this.J;if(!g.VJ(b,a)){var c=g.T(a,2);c!==g.T(this.J,2)&&this.I.Us(c);this.J=a;HUa(this.u,b,a)}};g.w(C9,g.V);C9.prototype.rd=function(){this.i.show()};
C9.prototype.Eb=function(){this.i.hide()};
C9.prototype.u=function(){S6("mdx-privacy-popup-cancel");this.Eb()};
C9.prototype.B=function(){S6("mdx-privacy-popup-confirm");this.Eb()};g.w(D9,g.V);D9.prototype.onStateChange=function(a){GUa(this,a.state)};g.w(E9,g.JP);E9.prototype.D=function(){var a=this.I.getOption("remote","receivers");a&&1<a.length&&!this.I.getOption("remote","quickCast")?(this.Yn=g.Rb(a,this.i,this),g.KP(this,g.pm(a,this.i)),a=this.I.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.Wh(a),this.enable(!0)):this.enable(!1)};
E9.prototype.i=function(a){return a.key};
E9.prototype.Zi=function(a){return"cast-selector-receiver"===a?"\u6295\u5c04\u2026":this.Yn[a].name};
...
g.k.load=function(){this.player.cancelPlayback();g.VM.prototype.load.call(this);this.ai=new y9(this,this.player,this.Tb);var a=(a=CUa())?a.currentTime:0;var b=v9()?new Q8(p9(),void 0):null;0==a&&b&&(a=M8(R8(b)));0!==a&&this.Qb(a);HUa(this,this.td,this.td);this.player.Rk(6)};
...
g.k.BM=function(){var a=[this.Gk],b=a.concat,c=zUa();E8()&&g.Mz("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Yn=b.call(a,c);a=q9()||this.Gk;H9(this,a);this.player.Oa("onMdxReceiversChange")};
